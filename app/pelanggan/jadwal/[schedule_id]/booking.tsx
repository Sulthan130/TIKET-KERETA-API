...
const Booking = (myProp: Props) => {
    ...
    useEffect(() => {
        /** copy data array dri properti "wagons" ke state "wagons" */
    ...
    const handleAddSeat = (seatBook: SeatBook) => {
        ...
        /** mencari posisi index dri kursi yang dipilih */
    ...
    return (
        <div>
            ...
            <button type="button"
            onClick={() => handleSave()}
            className="w-full rounded-md my-2 bg-green-600 hover:bg-gren-500 text-white">
                Pesan Sekarang
            </button>
        </div>
    )
